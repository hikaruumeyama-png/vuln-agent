...
class ChatWebhookTests(unittest.TestCase):
    ...
    def test_build_ticket_text_from_sidfm_sample_filters_alma10_and_formats_detail(self):
        ...
        self.assertIn("AlmaLinux10", out)
        self.assertIn("SBOM未登録", out)
        ...
        self.assertIn("https://sid.softek.jp/filter/sinfo/61841", out)
        self.assertIn("https://sid.softek.jp/filter/sinfo/61851", out)
    ...
    def test_build_ticket_text_from_sidfm_mixed_versions_keeps_only_sbom_versions(self):
        ...
        self.assertIn("https://sid.softek.jp/filter/sinfo/62977", out)
        self.assertIn("https://sid.softek.jp/filter/sinfo/62990", out)
        self.assertIn("起票対象: 4件", out)
